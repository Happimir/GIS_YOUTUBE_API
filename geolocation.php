...
if (isset($_GET['q'])
    ...
    */
    ...
    try {
        ...
        echo "<script src='actions.js'></script>
        
        <script>addVideoMarkers(" . json_encode($title) . "," . json_encode($lat) . ","  . json_encode($lon) . ");
        ...
        foreach( $lat as $index => $latitude ) {
            echo $latitude . $lon[$index] . "<br>";
        }
